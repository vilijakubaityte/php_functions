...
<head>
    ...
    <link rel="stylesheet" href="skelbimas.css">
</head>
</body>
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="skelbimas.php">Skelbimai</a>
                </li>
            </ul>
        </div>
    </div>
            ...
            <div class="col-md-12 mt-5">
                <table class="table">
                    ...
                    <tr>
                        ...
                        <th>Skelbimas</th>
                        <th>
                            <?php printTableLink('Kaina', 'cost', $order, $dir) ?>
                        </th>
                        <th>
                            <?php printTableLink('Sumokėta', 'onPay', $order, $dir) ?>
                    </tr>
                    </thead>
                    <tbody>
